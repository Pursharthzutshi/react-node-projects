...
function Navbar(){
 ...
 localStorage.setItem("setChangeLogIn",true);
    ...
    return(
        ...
        <Route path = "/LogIn" element = {<LogIn changeLogIn={changeLogIn} setChangeLogIn={setChangeLogIn} setShowUserAccount={setShowUserAccount}/>}>{changeLogIn}</Route>
